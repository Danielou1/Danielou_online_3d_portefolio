...
#endif`,O_="gl_FragColor = linearToOutputTexel( gl_FragColor );",N_=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
`)+`
`+f);let S=E+p+o,M=E+f+a,D=Gm(r,r.VERTEX_SHADER,S),R=Gm(r,r.FRAGMENT_SHADER,M);r.attachShader(y,D),r.attachShader(y,R),t.index0AttributeName!==void 0?r.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function T(A){if(i.debug.checkShaderErrors){let z=r.getProgramInfoLog(y).trim(),k=r.getShaderInfoLog(D).trim(),j=r.getShaderInfoLog(R).trim(),X=!0,H=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(X=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,y,D,R);else{let J=Xm(r,D,"vertex"),G=Xm(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,side:Kt,depthWrite:!1}),r=new te(t,n);this.scene.add(r)}addBahnhofLampPost(){let t=new Mt,n=new te(new Dt(.08,.08,5,16),new Te({color:2236962,metalness:1}));n.position.y=2.5,t.add(n);let r=new mo().load("assets/clock-bahnhof.jpg"),s=new nn({map:r,side:Pn}),o=new te(new ts(.5,32),s);o.position.set(0,3.8,.48),t.add(o);let a=new te(new Xe(.05,.05,.5),new Te({color:4473924}));a.position.set(0,3.8,.25),t.add(a);let l=.5;[-.25,.25].forEach(d=>{let m=new te(new Dt(.015,.015,l),new Te({color:8947848}));m.rotation.z=Math.PI/2,m.position.set(d,4.6,0),t.add(m);let g=new te(new Dt(.01,.01,.2),new Te({color:3355443}));g.position.set(d+(d>0?l/2:-l/2),4.5,0),t.add(g);let y=new te(new Hn(.15,16,16),new Te({color:16777164,emissive:16764040,emissiveIntensity:.9}));y.position.set(d+(d>0?l/2:-l/2),4.3,0),t.add(y);let p=new pi(16764040,.6,6);p.position.copy(y.position),t.add(p)});let c=["Profil","Daten","Skills","SoftSkills","Projekte","Akademisch","Sprachen","Erfahrung"],u=[Math.PI/2,Math.PI/3,-Math.PI/2,-Math.PI/3,0,Math.PI/4,-Math.PI/4,Math.PI],h=(d,m=!1)=>{let g=document.createElement("canvas");g.width=512,g.height=128;let y=g.getContext("2d");y.fillStyle="#ffffff",y.fillRect(0,0,g.width,g.height),y.font="bold 48px sans-serif",y.textAlign="center",y.textBaseline="middle",y.fillStyle="#000000",m&&(y.translate(g.width,0),y.scale(-1,1)),y.fillText(d,g.width/2,g.height/2);let p=new Jn(g);return p.needsUpdate=!0,p};c.forEach((d,m)=>{let g=new rn(1.4,.3),y=new nn({map:h(d),side:Rn}),p=new nn({map:h(d,!0),side:Rn}),f=new te(g,y);f.position.set(0,3.3-m*.4,0),f.rotation.y=u[m],f.translateX(.7),t.add(f);let E=new te(g,p);E.position.copy(f.position),E.rotation.copy(f.rotation),E.rotateY(Math.PI),t.add(E),this.signPanels.push({mesh:f,label:d})}),t.position.set(-5.5,0,5),this.scene.add(t)}static{this.\u0275fac=function(n){return new(n||i)(ke(ri),ke(Lr),ke(kt),ke(ec))}}static{this.\u0275cmp=Et({type:i,selectors:[["app-three-scene"]],viewQuery:function(n,r){if(n&1&&bd(DS,7),n&2){let s;gc(s=vc())&&(r.canvasRef=s.first)}},standalone:!0,features:[Tt],decls:2,vars:0,consts:[["canvas",""],[2,"cursor","grab"]],template:function(n,r){n&1&&ve(0,"canvas",1,0)},styles:["canvas[_ngcontent-%COMP%]{width:100%;height:100vh;display:block}"]})}}return i})();var og=(()=>{class i{constructor(t,n,r){this.languageService=t,this.sceneControlService=n,this.router=r,this.currentLanguage="de",this.qaRules=[{keywords:{de:["hallo","guten tag","hey","hi","bonjour","wie gehts","wie geht es","gr\xFC\xDF gott"],en:["hello","hi","hey","how are you","good day"]},answer:{de:"Hallo! Ich bin Danielou, Ihr virtueller Assistent. Mir geht es gut, danke! Fragen Sie mich alles \xFCber mein Profil, meine Projekte oder meine F\xE4higkeiten.",en:"Hello! I am Danielou, your virtual assistant. I'm doing well, thank you! Feel free to ask me anything about my profile, projects, or skills."}},{keywords:{de:["erz\xE4hlen sie von sich","\xFCber sie","wer sind sie","person","pers\xF6nlichkeit","beschreiben sie sich","was machen sie","was tust du"],en:["about you","who are you","your personality","describe yourself","tell me about yourself","what do you do"]},answer:{de:"Ich bin Danielou Mounsande Sandamoun, ein zielstrebiger und neugieriger angehender Ingenieur-Informatiker von der THM. Meine Leidenschaft f\xFCr Technologie se verbindet mit praktischer Erfahrung in der Softwareentwicklung und einem starken Fokus auf das L\xF6sen komplexer Probleme.",en:"I am Danielou Mounsande Sandamoun, a determined and curious aspiring Applied Computer Science engineer from THM. I combine a passion for technology with practical software development experience and a strong focus on solving complex problems."}},{keywords:{de:["st\xE4rken","vorteile","was zeichnet sie aus","gut in"],en:["strengths","advantages","what sets you apart","good at"]},answer:{de:"Meine gr\xF6\xDFten St\xE4rken sind meine schnelle Auffassungsgabe, meine Probleml\xF6sungskompetenz und meine F\xE4higkeit, mich in neue Technologien einzuarbeiten. Ich bin ein Teamplayer, der sowohl in der Embedded-Entwicklung mit C++ als auch in der Anwendungsentwicklung mit Java \xFCberzeugt.",en:"My greatest strengths are my quick comprehension, problem-solving skills, and my ability to learn new technologies. I am a team player who excels in both embedded development with C++ and application development with Java."}},{keywords:{de:["schw\xE4chen","nachteile","herausforderungen"],en:["weakness","weaknesses","challenges"]},answer:{de:"Ich bin manchmal ungeduldig, ein Problem zu l\xF6sen, was mich aber dazu antreibt, die effizienteste und nicht nur die schnellste L\xF6sung zu finden. Ich lerne st\xE4ndig, diese Energie in eine noch strukturiertere Analyse zu lenken.",en:"I can be impatient to solve a problem, but this drives me to find the most efficient solution, not just the quickest one. I am constantly learning to channel this energy into even more structured analysis."}},{keywords:{de:["was suchen sie","n\xE4chste schritte","karriereziele","job","stelle","position"],en:["what are you looking for","next steps","career goals","job","position"]},answer:{de:"Ich suche eine herausfordernde Position als Softwareentwickler, idealerweise im Bereich Embedded Systems oder hardwarenahe Programmierung, wo ich meine Kenntnisse in C++ und Java vertiefen und an innovativen Projekten mitwirken kann.",en:"I am looking for a challenging position as a software developer, ideally in embedded systems or hardware-related programming, where I can deepen my knowledge of C++ and Java and contribute to innovative projects."}},{keywords:{de:["verf\xFCgbarkeit","anfangen","starttermin","eintrittsdatum","wann verf\xFCgbar"],en:["availability","start date","when can you start","available"]},answer:{de:"Ich schlie\xDFe mein Studium Ende 2025 ab und stehe ab dem 01.01.2026 f\xFCr eine Vollzeitstelle zur Verf\xFCgung. F\xFCr Praktika oder Werkstudentent\xE4tigkeiten bin ich nach Absprache flexibel.",en:"I will complete my studies at the end of 2025 and will be available for a full-time position from January 1st, 2026. I am flexible for internships or working student positions by arrangement."}},{keywords:{de:["erfahrung","berufserfahrung","arbeit","praktika"],en:["experience","work","background","internships"]},answer:{de:'Ich habe praktische Erfahrungen in der Forschung an der THM, als Dolmetscher beim BAMF und im CNC-Bereich bei Schunk gesammelt. M\xF6chten Sie zum Abschnitt "Berufserfahrung" navigieren, um die Details zu sehen?',en:'I have gained practical experience in research at THM, as an interpreter at BAMF, and in the CNC field at Schunk. Would you like to navigate to the "Work Experience" section to see the details?'},navigationTarget:"erfahrung"},{keywords:{de:["studium","akademisch","bildung","hochschule","ausbildung","wo studiert","universit\xE4t","thm"],en:["education","academic","university","degree","where did you study","college","thm"]},answer:{de:"Ich absolviere meinen Bachelor in Ingenieur-Informatik an der Technischen Hochschule Mittelhessen (THM). M\xF6chten Sie die Details meiner akademischen Laufbahn sehen?",en:"I am completing my Bachelor in Applied Computer Science at the Technical University of Central Hesse (THM). Would you like to see the details of my academic journey?"},navigationTarget:"akademisch"},{keywords:{de:["exambuilder","bachelorarbeit","abschlussprojekt"],en:["exambuilder","bachelor thesis","final project"]},answer:{de:"ExamBuilder ist meine Bachelorarbeit, eine Desktop-Anwendung in JavaFX zur Erstellung und Verwaltung von Pr\xFCfungen. Ein Kernfeature ist die KI-gest\xFCtzte Neuformulierung von Fragen. M\xF6chten Sie mehr \xFCber meine Projekte erfahren?",en:"ExamBuilder is my bachelor thesis, a desktop application built with JavaFX for creating and managing exams. A core feature is the AI-powered rephrasing of questions. Would you like to learn more about my projects?"},navigationTarget:"projekte"},{keywords:{de:["projekte","portfolio","was hast du gemacht"],en:["projects","portfolio","what have you done"]},answer:{de:'Ich habe an mehreren Projekten gearbeitet, darunter meine Bachelorarbeit "ExamBuilder" und ein SmartLab-System. Soll ich Sie zur Projekt\xFCbersicht bringen?',en:'I have worked on several projects, including my bachelor thesis "ExamBuilder" and a SmartLab system. Shall I take you to the projects overview?'},navigationTarget:"projekte"},{keywords:{de:["kompetenzen","skills","f\xE4higkeiten","technologien","c++","java","python","embedded systems","angular","webentwicklung","datenbanken"],en:["skills","competencies","technologies","c++","java","python","embedded systems","angular","web development","databases"]},answer:{de:"Meine Kernkompetenzen sind C++, Java und Python, mit einem starken Fokus auf Embedded Systems. Ich habe aber auch Erfahrung in der Web-Entwicklung (Angular) und mit Datenbanken. Wollen Sie die detaillierte Liste sehen?",en:"My core competencies are C++, Java, and Python, with a strong focus on Embedded Systems. I also have experience in web development (Angular) and databases. Would you like to see the detailed list?"},navigationTarget:"skills"},{keywords:{de:["sprachen","welche sprachen"],en:["languages","what languages"]},answer:{de:"Meine Muttersprache ist Franz\xF6sisch. Ich spreche au\xDFerdem flie\xDFend Deutsch (C1) und gutes Englisch (B2). Soll ich Sie zur Sprachen-Sektion f\xFChren?",en:"My native language is French. I also speak fluent German (C1) and good English (B2). Shall I take you to the languages section?"},navigationTarget:"sprachen"},{keywords:{de:["hobbys","freizeit","was machst du gerne"],en:["hobbies","free time","what do you like to do"]},answer:{de:"In meiner Freizeit lese ich gerne Fachliteratur, spiele Fu\xDFball und arbeite an eigenen kleinen Programmierprojekten, um neue Technologien zu lernen.",en:"In my free time, I enjoy reading technical literature, playing soccer, and working on my own small programming projects to learn new technologies."}},{keywords:{de:["email","telefon","kontakt","anschrift","wie erreiche ich dich","kontaktdaten"],en:["email","phone","contact","address","how to reach you","contact details"]},answer:{de:'Meine Kontaktdaten finden Sie im Abschnitt "Daten". Aus Datenschutzgr\xFCnden gebe ich sie hier im Chat nicht direkt an. Wenn Sie mir eine E-Mail senden m\xF6chten, k\xF6nnen Sie dies tun unter <a href="mailto:mounsandedaniel@gmail.com" class="text-blue-400 hover:underline">mounsandedaniel@gmail.com</a>.',en:'You can find my contact details in the "Data" section. For privacy reasons, I will not provide them directly here in the chat. If you wish to send me an email, you can do so at <a href="mailto:mounsandedaniel@gmail.com" class="text-blue-400 hover:underline">mounsandedaniel@gmail.com</a>.'},navigationTarget:"daten"}],this.defaultAnswers={de:'Das ist eine gute Frage. Ich habe dazu keine vorprogrammierte Antwort. F\xFCr spezifische Anfragen kontaktieren Sie Daniel bitte direkt unter <a href="mailto:mounsandedaniel@gmail.com" class="text-blue-400 hover:underline">mounsandedaniel@gmail.com</a>.',en:`That's a great question. I don't have a pre-programmed answer for that. For specific inquiries, please contact Daniel directly at <a href="mailto:mounsandedaniel@gmail.com" class="text-blue-400 hover:underline">mounsandedaniel@gmail.com</a>.`},this.langSub=this.languageService.language$.subscribe(s=>{this.currentLanguage=s})}ngOnDestroy(){this.langSub.unsubscribe()}triggerNavigation(t){this.router.navigate([`/${t.toLowerCase()}`]),this.sceneControlService.requestZoom("screen")}normalizeQuestion(t){return t.toLowerCase().replace(/[.,/#!$%^&*;:{}=\-_`~()]/g,"").replace(/\s{2,}/g," ").trim()}matchesKeyword(t,n){return new RegExp(`\\b${n}\\b`,"i").test(t)}getAnswer(t){let n=this.normalizeQuestion(t);console.log("--- New Question ---"),console.log(`Normalized Question: "${n}"`),console.log(`Language: ${this.currentLanguage}`);for(let r of this.qaRules){let o=(r.keywords[this.currentLanguage]||r.keywords.de).find(a=>this.matchesKeyword(n,a));if(o)return console.log(`SUCCESS: Matched keyword "${o}" for rule with answer: "${r.answer[this.currentLanguage].substring(0,20)}"...`),{text:r.answer[this.currentLanguage]||r.answer.de,navigationTarget:r.navigationTarget}}return console.log("FAILURE: No rule matched. Returning default answer."),{text:this.defaultAnswers[this.currentLanguage]||this.defaultAnswers.de}}static{this.\u0275fac=function(n){return new(n||i)(wt(jt),wt(kt),wt(Lr))}}static{this.\u0275prov=ut({token:i,factory:i.\u0275fac,providedIn:"root"})}}return i})();var OS=(i,e)=>({"user-message":i,"bot-message":e});function NS(i,e){i&1&&(Ue(),U(0,"svg",4),ve(1,"path",5),Y())}function FS(i,e){i&1&&(Ue(),U(0,"svg",4),ve(1,"path",6),Y())}function US(i,e){i&1&&(U(0,"div",27),ve(1,"img",28),Y())}function kS(i,e){if(i&1){let t=Ms();U(0,"button",29),ot("click",function(){bi(t);let r=dn().$implicit,s=dn(2);return Si(s.handleNavigationClick(r.navigationTarget))}),De(1," Zeigen Sie mir den Abschnitt "),Y()}}function BS(i,e){if(i&1&&(U(0,"div",22),xt(1,US,2,0,"div",23),U(2,"div",24),ve(3,"span",25),xt(4,kS,2,0,"button",26),Y()()),i&2){let t=e.$implicit;Je("ngClass",Cd(4,OS,t.sender==="user",t.sender==="bot")),ce(),Je("ngIf",t.sender==="bot"),ce(2),Je("innerHTML",t.text,ys),ce(),Je("ngIf",t.navigationTarget)}}function VS(i,e){if(i&1){let t=Ms();U(0,"div",7)(1,"div",8)(2,"div",9),ve(3,"img",10)(4,"span",11),Y(),U(5,"div",12)(6,"h3",13),De(7,"Danielou M."),Y(),U(8,"p",14),De(9,"Online"),Y()()(),U(10,"div",15),xt(11,BS,5,7,"div",16),Y(),U(12,"div",17)(13,"input",18),Td("ngModelChange",function(r){bi(t);let s=dn();return Ed(s.userInput,r)||(s.userInput=r),Si(r)}),ot("keyup.enter",function(){bi(t);let r=dn();return Si(r.sendMessage())}),Y(),U(14,"button",19),ot("click",function(){bi(t);let r=dn();return Si(r.sendMessage())}),Ue(),U(15,"svg",20),ve(16,"path",21),Y()()()()}if(i&2){let t=dn();ce(11),Je("ngForOf",t.messages),ce(2),wd("ngModel",t.userInput)}}var ag=(()=>{class i{constructor(t){this.chatbotService=t,this.isOpen=!1,this.messages=[],this.userInput=""}ngOnInit(){this.messages.push({sender:"bot",text:"Hallo! Ich bin der virtuelle Avatar von Danielou. Stellen Sie mir gerne Ihre Fragen."})}toggleChat(){this.isOpen=!this.isOpen}sendMessage(){if(this.userInput.trim()==="")return;this.messages.push({sender:"user",text:this.userInput});let t=this.chatbotService.getAnswer(this.userInput);this.messages.push({sender:"bot",text:t.text,navigationTarget:t.navigationTarget}),this.userInput=""}handleNavigationClick(t){t&&(this.chatbotService.triggerNavigation(t),this.isOpen=!1)}static{this.\u0275fac=function(n){return new(n||i)(ke(og))}}static{this.\u0275cmp=Et({type:i,selectors:[["app-chatbot"]],standalone:!0,features:[Tt],decls:5,vars:3,consts:[[1,"chatbot-container"],[1,"chat-toggle-button",3,"click"],["xmlns","http://www.w3.org/2000/svg","fill","none","viewBox","0 0 24 24","stroke-width","1.5","stroke","currentColor","class","w-8 h-8",4,"ngIf"],["class","chat-window",4,"ngIf"],["xmlns","http://www.w3.org/2000/svg","fill","none","viewBox","0 0 24 24","stroke-width","1.5","stroke","currentColor",1,"w-8","h-8"],["stroke-linecap","round","stroke-linejoin","round","d","M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z"],["stroke-linecap","round","stroke-linejoin","round","d","M6 18L18 6M6 6l12 12"],[1,"chat-window"],[1,"chat-header"],[1,"avatar-container"],["src","assets/photo.png","alt","Avatar de Danielou",1,"avatar"],[1,"status-indicator"],[1,"header-info"],[1,"font-bold"],[1,"text-xs"],[1,"chat-body"],["class","message-container",3,"ngClass",4,"ngFor","ngForOf"],[1,"chat-footer"],["type","text","placeholder","Stellen Sie Ihre Frage...",1,"chat-input",3,"ngModelChange","keyup.enter","ngModel"],[1,"send-button",3,"click"],["xmlns","http://www.w3.org/2000/svg","fill","none","viewBox","0 0 24 24","stroke-width","1.5","stroke","currentColor",1,"w-6","h-6"],["stroke-linecap","round","stroke-linejoin","round","d","M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5"],[1,"message-container",3,"ngClass"],["class","avatar-container-small",4,"ngIf"],[1,"message"],[3,"innerHTML"],["class","navigation-button",3,"click",4,"ngIf"],[1,"avatar-container-small"],["src","assets/photo.png","alt","Avatar de Danielou",1,"avatar-small"],[1,"navigation-button",3,"click"]],template:function(n,r){n&1&&(U(0,"div",0)(1,"button",1),ot("click",function(){return r.toggleChat()}),xt(2,NS,2,0,"svg",2)(3,FS,2,0,"svg",2),Y(),xt(4,VS,17,2,"div",3),Y()),n&2&&(ce(2),Je("ngIf",!r.isOpen),ce(),Je("ngIf",r.isOpen),ce(),Je("ngIf",r.isOpen))},dependencies:[Ft,Ld,Xt,Sr,ga,fa,tp,wu],styles:[".chatbot-container[_ngcontent-%COMP%]{position:fixed;bottom:20px;right:20px;z-index:1000}.chat-toggle-button[_ngcontent-%COMP%]{background-color:#1a202c;color:#cbd5e0;border:1px solid #4a5568;border-radius:50%;width:60px;height:60px;display:flex;justify-content:center;align-items:center;cursor:pointer;box-shadow:0 4px 6px #0000001a;transition:all .3s ease}.chat-toggle-button[_ngcontent-%COMP%]:hover{background-color:#2d3748}.chat-window[_ngcontent-%COMP%]{width:350px;height:500px;background-color:#1a202c;border-radius:15px;box-shadow:0 10px 15px #0003;display:flex;flex-direction:column;overflow:hidden;border:1px solid #4a5568}.chat-header[_ngcontent-%COMP%]{padding:1rem;background-color:#2d3748;display:flex;align-items:center;gap:.75rem;color:#e2e8f0}.avatar-container[_ngcontent-%COMP%]{position:relative}.avatar[_ngcontent-%COMP%]{width:40px;height:40px;border-radius:50%;border:2px solid #718096}.status-indicator[_ngcontent-%COMP%]{position:absolute;bottom:0;right:0;width:10px;height:10px;background-color:#48bb78;border-radius:50%;border:2px solid #2d3748}.header-info[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%]{margin:0;font-size:1rem}.header-info[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{margin:0;color:#a0aec0}.chat-body[_ngcontent-%COMP%]{flex-grow:1;padding:1rem;overflow-y:auto;display:flex;flex-direction:column;gap:.75rem;color:#e2e8f0}.message-container[_ngcontent-%COMP%]{display:flex;align-items:flex-start;gap:.5rem;max-width:85%}.bot-message[_ngcontent-%COMP%]{align-self:flex-start}.user-message[_ngcontent-%COMP%]{align-self:flex-end}.message[_ngcontent-%COMP%]{padding:.75rem;border-radius:15px;line-height:1.4}.bot-message[_ngcontent-%COMP%]   .message[_ngcontent-%COMP%]{background-color:#2d3748;border-top-left-radius:0}.navigation-button[_ngcontent-%COMP%]{display:block;margin-top:.75rem;padding:.5rem .75rem;background-color:#4a5568;color:#e2e8f0;border:none;border-radius:10px;cursor:pointer;font-size:.8rem;font-weight:700;transition:background-color .2s ease}.navigation-button[_ngcontent-%COMP%]:hover{background-color:#718096}.user-message[_ngcontent-%COMP%]   .message[_ngcontent-%COMP%]{background-color:#4a5568;color:#fff;border-top-right-radius:0}.avatar-small[_ngcontent-%COMP%]{width:30px;height:30px;border-radius:50%}.chat-footer[_ngcontent-%COMP%]{display:flex;padding:.75rem;background-color:#2d3748;border-top:1px solid #4a5568}.chat-input[_ngcontent-%COMP%]{flex-grow:1;background-color:#1a202c;border:1px solid #4a5568;border-radius:20px;padding:.5rem 1rem;color:#e2e8f0;outline:none}.chat-input[_ngcontent-%COMP%]::placeholder{color:#718096}.send-button[_ngcontent-%COMP%]{background:none;border:none;color:#a0aec0;cursor:pointer;padding:.5rem;margin-left:.5rem}.send-button[_ngcontent-%COMP%]:hover{color:#e2e8f0}.chat-body[_ngcontent-%COMP%]::-webkit-scrollbar{width:8px}.chat-body[_ngcontent-%COMP%]::-webkit-scrollbar-track{background:#1a202c}.chat-body[_ngcontent-%COMP%]::-webkit-scrollbar-thumb{background-color:#4a5568;border-radius:4px}"]})}}return i})();var lg=(()=>{class i{constructor(t){this.syncService=t,this.title="danielou-portfolio",this.panelState={visible:!1,transform:""}}ngOnInit(){this.panelSub=this.syncService.panelState$.subscribe(t=>{this.panelState=t})}ngOnDestroy(){this.panelSub&&this.panelSub.unsubscribe()}static{this.\u0275fac=function(n){return new(n||i)(ke(ec))}}static{this.\u0275cmp=Et({type:i,selectors:[["app-root"]],standalone:!0,features:[Tt],decls:13,vars:4,consts:[[1,"html-panel"],[1,"fixed","bottom-4","left-4","z-20","flex","space-x-4"],["href","https://github.com/Danielou1","target","_blank",1,"social-link","text-white","hover:text-gray-300"],["xmlns","http://www.w3.org/2000/svg","width","24","height","24","viewBox","0 0 24 24","fill","none","stroke","currentColor","stroke-width","2","stroke-linecap","round","stroke-linejoin","round",1,"feather","feather-github"],["d","M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.54 2.74c0 5.46 3.3 6.65 6.44 7A3.37 3.37 0 0 0 9 18.13V22"],["href","https://www.linkedin.com/in/danielou-mounsande/","target","_blank",1,"social-link","text-white","hover:text-gray-300"],["xmlns","http://www.w3.org/2000/svg","width","24","height","24","viewBox","0 0 24 24","fill","none","stroke","currentColor","stroke-width","2","stroke-linecap","round","stroke-linejoin","round",1,"feather","feather-linkedin"],["d","M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"],["x","2","y","9","width","4","height","12"],["cx","4","cy","4","r","2"]],template:function(n,r){n&1&&(ve(0,"app-three-scene"),U(1,"div",0),ve(2,"router-outlet"),Y(),U(3,"div",1)(4,"a",2),Ue(),U(5,"svg",3),ve(6,"path",4),Y()(),et(),U(7,"a",5),Ue(),U(8,"svg",6),ve(9,"path",7)(10,"rect",8)(11,"circle",9),Y()()(),et(),ve(12,"app-chatbot")),n&2&&(ce(),Uo("transform",r.panelState.transform),ko("visible",r.panelState.visible))},dependencies:[Ft,du,sg,ag],styles:[".html-panel[_ngcontent-%COMP%]{position:fixed;top:0;left:0;width:800px;height:500px;background-color:#1a202ce6;border-radius:12px;box-shadow:0 10px 30px #00000080;-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.1);pointer-events:none;opacity:0;transition:opacity .4s ease,transform .4s ease;will-change:transform,opacity;z-index:10;overflow:hidden}.html-panel.visible[_ngcontent-%COMP%]{opacity:1;pointer-events:auto}@media (max-width: 850px){.html-panel[_ngcontent-%COMP%]{width:95vw;height:80vh}}"]})}}return i})();ef(lg,pp).catch(i=>console.error(i));
